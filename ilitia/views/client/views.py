...
from ilitia.forms import ClientForm
from hades.mixins import ValidatePermissionRequiredMixin
from ilitia.models import Client
...
class ClientListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('ilitia:client_create')
        context['list_url'] = reverse_lazy('ilitia:client_list')
...
class ClientCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('ilitia:client_list')
...
class ClientUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'edit':
                form = self.get_form()
                form.instance.update_by = request.user
