...
from artemisa.forms import CategoryForm
from hades.mixins import ValidatePermissionRequiredMixin
from artemisa.models import Category
...
class CategoryListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('artemisa:category_create')
        context['list_url'] = reverse_lazy('artemisa:category_list')
...
class CategoryCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('artemisa:category_list')
